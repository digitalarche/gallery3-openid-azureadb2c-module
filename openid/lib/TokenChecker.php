...
class TokenChecker {
	...
	function __construct($tenant, $resp, $resp_type, $clientID, $client_secret, $policy_name) {
		$this->clientID = $clientID;
		$this->client_secret = $client_secret;
		$this->endpointHandler = new EndpointHandler($tenant, $policy_name);
	...
	private function validateClaims() {
        ...
        // yoichika skip this :::: don't know why this happen. let's figure out later, so skip
